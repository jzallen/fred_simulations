...
class TestJobResultsEndpoint:
    ...
    def test_get_job_results__returns_urls_for_job(self, client, bearer_token, setup_runs_with_urls):
    ...
    def test_get_job_results__no_runs_for_job__returns_empty_list(self, client, bearer_token, setup_runs_with_urls):
