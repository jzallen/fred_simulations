...
from epistemix_api.models import (
...
if TYPE_CHECKING:
    from epistemix_api.models import JobUpload # pants: no-infer-dep
    from epistemix_api.repositories.interfaces import IUploadLocationRepository # pants: no-infer-dep
