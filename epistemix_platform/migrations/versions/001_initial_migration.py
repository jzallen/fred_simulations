...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column('status', sa.Enum('CREATED', 'SUBMITTED', 'PROCESSING', 'COMPLETED', 'FAILED', 'CANCELLED', name='jobstatusenum'), nullable=False, server_default='CREATED'),
        ...
        sa.Column('job_metadata', sa.JSON(), nullable=False, server_default='{}'),
    ...
    op.create_table(
        ...
        sa.Column('pod_phase', sa.Enum('PENDING', 'RUNNING', 'SUCCEEDED', 'FAILED', 'UNKNOWN', name='podphaseenum'), nullable=False, server_default='RUNNING'),
        sa.Column('container_status', sa.String(), nullable=True),
        sa.Column('status', sa.Enum('QUEUED', 'NOT_STARTED', 'RUNNING', 'ERROR', 'DONE', 'SUBMITTED', 'RUNNING_LEGACY', 'FAILED', 'CANCELLED', name='runstatusenum'), nullable=False, server_default='SUBMITTED'),
        sa.Column('user_deleted', sa.Integer(), nullable=False, server_default='0'),
        sa.Column('epx_client_version', sa.String(), nullable=False, server_default='1.2.2'),
