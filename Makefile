...
format:
	...
	poetry run black epistemix_platform/ simulations/ *.py --exclude "fred-framework"
	poetry run isort epistemix_platform/ simulations/ *.py --skip fred-framework

lint:
	@echo "Running linters..."
	poetry run black epistemix_platform/ simulations/ *.py --check --exclude "fred-framework"
	poetry run flake8 epistemix_platform/ simulations/ *.py --max-line-length=100 --extend-ignore=E203,W503
...
test:
	@echo "Running epistemix_platform tests in parallel..."
...
help:
	...
	@echo "  test             - Run epistemix_platform tests in parallel"
	@echo ""
